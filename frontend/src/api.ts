...
export const api = {
  ...
  async createRoomBooking(args: { tenant?: string; room_id: number; start_at: string; duration: string; purpose?: string; booked_by?: string }) {
    return await post<any>(`/api/rooms/bookings`, { room_id: args.room_id, start_at: args.start_at, duration: args.duration, purpose: args.purpose, booked_by: args.booked_by }, { tenant: args.tenant });
  },
